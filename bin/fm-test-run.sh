...
family_for_basename() {
  case "$1" in
    ...
    fm-herdr-integration-coverage-live-e2e.test.sh|\
    fm-cortex-herdr-lifecycle-live-e2e.test.sh|\
...
tests/fm-cortex-herdr-lifecycle-live-e2e.test.sh 23
...
tests/fm-herdr-integration-coverage-live-e2e.test.sh 23
