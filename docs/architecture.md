...
That keeps spawn launch compatible across every verified adapter while preserving the requested profile for later audit; [`configuration.md`](configuration.md#harness-support) owns which adapters those are.
